...
export async function requestSMSCode(
  ...
  return await signInWithPhoneNumber(auth, numberPhone, appVerifier);
}

export async function checkSMSCode(code: string, confirm: ConfirmationResult) {
  await confirm.confirm(code);
}

export async function addHiddenCAPTCHA() {
