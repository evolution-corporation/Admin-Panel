    ...
    <>
      <reactNative.Animated.View
        ...
        onLayout={({ nativeEvent: { layout } }) => {
          dispatch({
            type: "editPositionAndWidthSelectRegionList",
            payload: [
              {
                x: layout.left,
      ...
      >
        ...
        >
          <reactNative.Text style={[styles.phoneStyle, { color: styleColor }]}>
          ...
          >
            <AntDesign name="caretup" size={"12px"} color={styleColor} />
          </reactNative.Animated.View>
        </reactNative.TouchableOpacity>
...
interface Props extends reactNative.ViewProps {
  ...
  styleColor?: reactNative.ColorValue;
}
...
function reducer(state: State, action: Action): State {
  switch (action.type) {
    ...
    case "closeModal":
      ...
      break;
    case "editPositionAndWidthSelectRegionList":
      state.positionSelectRegionList = action.payload[0];
      state.widthSelectRegion = action.payload[1];
      break;
    case "editRegionCode":
...
type Action =
  ...
  | ActionReducerWithPayload<
      "editPositionAndWidthSelectRegionList",
